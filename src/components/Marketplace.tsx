  ...
  const lifestyleTips = [
    {
      ...
      description: "Start your day with 10 minutes of stretching and meditation",
      icon: Calendar
    },
    {
      title: "Hydration",
    ...
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Find the perfect dietician for your needs</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <CardContent className="p-4">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{dietician.specialization}</p>
                      </div>
                      <div className="flex items-center gap-1">
                        <Star className="h-4 w-4 text-yellow-400" />
                    ...
                    <p className="text-sm mt-2">Experience: {dietician.experience}</p>

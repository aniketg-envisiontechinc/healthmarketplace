    ...
    switch (step) {
      ...
      case 2:
        ...
        if (
          ...
          userData.targetWeight < 30 ||
          userData.targetWeight > 300
        ) {
          newErrors.targetWeight =
            "Please enter a valid target weight between 30kg and 300kg";
          isValid = false;
        }
        break;
      case 3:
        ...
        return (
          ...
          >
            <div className="space-y-2">
              ...
              <Input
                className={`bg-black border-[#2A2A2A] text-white h-12 placeholder:text-[#4A4A4A] ${errors.name ? "border-red-500" : ""}`}
                value={userData.name}
            ...
            <div className="space-y-2">
              ...
              <Input
                className={`bg-black border-[#2A2A2A] text-white h-12 placeholder:text-[#4A4A4A] ${errors.age ? "border-red-500" : ""}`}
                type="number"
                value={userData.age.toString()}
                onChange={(e) =>
                  updateUserData("age", parseInt(e.target.value) || 0)
                }
              ...
              >
                <div className="flex items-center space-x-2">
                  <RadioGroupItem
                    value="male"
                    id="male"
                    className="border-[#2A2A2A] data-[state=checked]:bg-white"
                  />
                ...
                <div className="flex items-center space-x-2">
                  <RadioGroupItem
                    ...
                    className="border-[#2A2A2A] data-[state=checked]:bg-white"
                  />
                  <Label htmlFor="other" className="text-white text-sm">
                    Other
                  </Label>
                </div>
              </RadioGroup>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <Slider
                ...
                onValueChange={([value]) =>
                  updateUserData("targetWeight", value)
                }
                min={30}
                max={200}
                step={1}
        ...
        return (
          ...
          >
            <div className="space-y-2">
              ...
              >
                <SelectTrigger
                  className={`bg-black border-[#2A2A2A] text-white h-12 ${errors.activityLevel ? "border-red-500" : ""}`}
                >
                  <SelectValue placeholder="Select your activity level" />
                </SelectTrigger>
                <SelectContent className="bg-black border-[#2A2A2A] text-white">
            ...
            <div className="space-y-3">
                  ...
                  <div
                    ...
                    className={`p-4 border rounded-xl cursor-pointer transition-colors ${
                      userData.fitnessGoals.includes(goal.id)
                        ...
                        : "border-black text-[#8B8B8B] hover:border-[#3A3A3A]"
                    }`}
                    onClick={() => {
              ...
              {errors.fitnessGoals && (
                <p className="text-red-500 text-sm">{errors.fitnessGoals}</p>
              )}
            </div>
          </motion.div>
        );
              ...
              <div className="grid grid-cols-2 gap-3">
                {dietaryPreferences.map((pref) => (
                  <div
                    ...
                    onClick={() => {
                      const newPrefs = userData.dietaryPreferences.includes(
                        pref.id,
                      )
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 bg-black">
      <div className="w-full max-w-[420px]">
        <Card className="bg-black border-[#1A1A1A]">
            ...
            <div className="flex justify-between pt-4">
              {step > 1 && (
                <Button
                  variant="outline"
                  onClick={handleBack}
                  className="border-black text-white hover:bg-black h-12 px-6"
                >

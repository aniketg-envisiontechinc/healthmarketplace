...
const ProfilePage = () => {
  ...
  const calculateRecommendedCalories = useCallback(() => {
    ...
    if (isNaN(currentWeightKg) || isNaN(targetWeightKg) || isNaN(monthsToAchieve) || monthsToAchieve <= 0) {
  ...
  useEffect(() => {
    ...
    if (recommendedCalories !== 'Invalid input' && recommendedCalories !== 'Unrealistic goal. Please adjust target weight or months.' && recommendedCalories !== 'Too few calories. Please adjust target weight or months.' && recommendedCalories !== '')
    {
      setCalorieGoal(parseInt(recommendedCalories));
    }
      const recommendedProtein = calculateRecommendedProtein();
        if (recommendedProtein !== 'Invalid input for target weight' && recommendedProtein !== '') {
    ...
    <div className="flex flex-col items-center justify-start min-h-screen py-4 gap-4 pb-32">
      ...
      <Card className="w-full max-w-md p-4">
        <CardHeader>
          ...
          <CardDescription>Enter your current and target weight to calculate your calorie goal.</CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="recommendedCalories">Recommended Calorie Intake</Label>
            <Input
            ...
            />
             ...
             <div className="space-y-2">
                        <Label htmlFor="recommendedProtein">Recommended Protein Intake (g)</Label>
                        <Input
